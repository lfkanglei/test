...
<h2><font style="display:block; text-align:center" color="blue" size="5">周报模板上传</font></h2>
		<div style="margin-left:400px;margin-top:80px;width:1000px"><table>
				<colgroup>
				...
				<tr>
					...
					<td style="width:33%"><input id="filetxt" type="text" value="未选择文件" /> <input class="weekly-button"
								id="filebtn" type="button" value="浏览"/> <input id="myfile" name="myfile" type="file" accept="file/doc"/>
					</td>
 		...
 		<div style="margin-left:200px;width:1000px"><table align="center">
			<tr>
			<td>&nbsp;</td>
